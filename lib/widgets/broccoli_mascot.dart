...
class _BroccoliPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
        Offset(w * 0.42, h * 0.40), w * 0.05, Paint()..color = Colors.white);
    canvas.drawCircle(
        Offset(w * 0.58, h * 0.40), w * 0.05, Paint()..color = Colors.white);
    ...
    final fork = Paint()
      ...
      ..style = PaintingStyle.stroke;
    canvas.drawLine(
        Offset(w * 0.10, h * 0.30), Offset(w * 0.07, h * 0.18), fork);
    canvas.drawLine(
        Offset(w * 0.12, h * 0.29), Offset(w * 0.10, h * 0.17), fork);
    canvas.drawLine(
        Offset(w * 0.14, h * 0.29), Offset(w * 0.13, h * 0.17), fork);
